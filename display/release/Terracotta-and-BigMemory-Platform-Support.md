...
|:------------------------------------------------------|-----:|-----:|---:|---:|---------------:|----------------:|---:|---------------:|---------------:|
| Terracotta<br>Ehcache                                 | 10.1<br>3.4.1   | 10.3<br>3.6.3   | 10.5<br>3.8.1   | 10.7<br>3.9.9   | 10.11<br>3.9.9 | 10.15<br>3.10.1 | 10.15<br>3.10.1 | 11.1<br>3.11.1 | 11.1<br>3.11.1 | 12.1<br>3.12.1 |
| **PLATFORM SUPPORT**                                  |       |       |   |   |                |                 |   |                |                |                |
| Windows Server 2012 (Datacenter and Standard Edition) |       |   X   | X | X |                |                 |   |                |                |                |
| Windows Server 2016 (Datacenter and Standard Edition) |       |   X   | X | X |              X |               X | X |              X |              X |              X |
| Windows Server 2019 (Datacenter and Standard Edition) |       |       | X | X |              X |               X | X |              X |              X |              X |
| Windows Server 2022 (Datacenter and Standard Edition) |       |       |   |   |                |               X | X |              X |              X |              X |
| Windows 8 (Pro and Enterprise)                        |       |   X   |   |   |                |                 |   |                |                |                |
| Windows 10 (Pro and Enterprise)                       |       |   X   | X | X |              X |               X | X |              X |              X |              X |
| Windows 11 (Pro and Enterprise)                       |       |       |   |   |                |               X | X |              X |              X |              X |
| Suse Linux Enterprise Server 15 SPx                   |       |       | X | X |              X |               X | X |              X |              X |              X |
| Suse Linux Enterprise Server 12 SPx                   |       |   X   | X | X |              X |                 |   |                |                |                |
| Red Hat Enterprise Linux Server 7.x                   |       |       | X | X |              X |               X | X |              X |              X |              X |
| Red Hat Enterprise Linux Server 8.x                   |       |       | X | X |              X |               X | X |              X |              X |              X |
| Red Hat Enterprise Linux Server 9.x                   |       |       |   |   |                |               X | X |              X |              X |              X |
| Centos 7.x                                            |       |   X   | X | X |                |                 |   |                |                |                |
| Ubuntu 18.07                                          |       |       |   | X |                |                 |   |                |                |                |
| Ubuntu 24.04                                          |       |       |   |   |                |                 | X |              X |              X |              X |
| AIX 7.3                                               |       |       |   |   |                |               X | X |              X |              X |              X |
| **BROWSER SUPPORT**                                   |       |       |   |   |                |                 |   |                |                |                |
| Microsoft Edge (latest)                               |       |       |   | X |              X |               X | X |              X |              X |              X |
| Microsoft IE 11.x                                     |       |       |   | X |              X |                 |   |                |                |                |
| Mozilla Firefox ESR 91                                |       |       |   |   |              X |               X | X |              X |              X |              X |
| Mozilla Firefox ESR 78                                |       |       |   |   |                |               X | X |              X |              X |              X |
| Mozilla Firefox ESR 68                                |       |       |   |   |              X |                 |   |                |                |                |
| Google Chrome (latest)                                |       |       |   |   |              X |               X | X |              X |              X |              X |
| **JDK SUPPORT**                                       |       |       |   |   |                |                 |   |                |                |                |
| Zulu 21.0 (21.0.06)                                   |       |       |   |   |                |                 | X |              X |              X |              X |
...
| IBM Semeru 17 on AIX 7.3                              |       |       |   |   |                |               X | X |              X |              X |              X |
| IBM Semeru 21 on AIX 7.3                              |       |       |   |   |                |                 |   |                |                |              X |
...
| **PRODUCT**                                           | 2017 | 2018 | 2019 | 2020 | 2021 | 2022 | 2023 | 2024 | 2025 | 2026 |
|:------------------------------------------------------|-----:|-----:|---:|---:|---:|---:|---:|---:|---:|---:|
| BigMemory Max<br>Ehcache                              | 4.3.4<br>2.10.4 | 4.3.6<br>2.10.6 | 4.3.8<br>2.10.8 | 4.3.9<br>2.10.9 | 4.3.10<br>2.10.10 | 4.4<br>2.11.0 | 4.4<br>2.11.0 | 4.4.1<br>2.11.1 | 4.4.1<br>2.11.1 | 4.5.1<br>2.12.1 |
| **PLATFORM SUPPORT**                                  |       |       |   |   |   |   |   |   |   |   |
| Windows Server 2012 (Datacenter and Standard Edition) |       |   X   | X | X |   |   |   |   |   |   |
...
| AIX 7.2 (no Java 11, Java 17) webM only               |       |   X   |   | X | X | X | X | X | X | X |
| AIX 7.3 (no Java 11, Java 21) webM only               |       |       |   |   |   | X | X | X | X | X |
